    ...
    for (let j=5; j<(width-2*squarewidth); j+=(squarewidth+pad)) {
      if (random() > threshold) {
        ...
        quad(
          ...
          i + thisnoise(i, j+squarewidth+pad), j + squarewidth + thisnoise(i, j+squarewidth+pad),
          i + squarewidth + thisnoise(i+squarewidth+pad, j+squarewidth+pad),
            j + squarewidth + thisnoise(i+squarewidth+pad, j+squarewidth+pad),
          i + squarewidth + thisnoise(i+squarewidth+pad, j), j + thisnoise(i+squarewidth+pad, j)
        );
      }
    }
  }
